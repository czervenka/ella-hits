...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ella_hits_hitcount', (
            ('hits', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
            ('position', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True)),
            ('publishable', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Publishable'], primary_key=True)),
            ('last_seen', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('ella_hits', ['hitcount'])


    def backwards(self, orm):
        # Deleting model 'hitcount'
        db.delete_table('ella_hits_hitcount')
